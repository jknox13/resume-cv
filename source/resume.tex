...
\makebox[18mm][l]{\bf{Languages:}} Python \textbullet C \textbullet Java \textbullet R\\
...
\makebox[18mm][l]{\bf{Systems:}} Linux (Arch, CentOS) \textbullet Docker \\
\sectionsep
...
\location{Sept 2018 - Present \space {\bf{\bf·}} \space 1 yr 8 mos \hfill San Francisco, CA}
\vspace{\topsep}
\begin{tightemize}
